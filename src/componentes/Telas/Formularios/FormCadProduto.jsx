...
export default function FormCadProdutos(props) {
        ...
        if (form.checkValidity()){
            if(props.ModoEdicao){
                props.setListaProdutos(props.listaDeProdutos.map((item) =>
                    item.codigo === props.produtoEdit.codigo ? props.produtoEdit : item
                  ));
    ...
    function manipularMudanca(evento){
        ...
        props.setProdutoEdit({...props.produtoEdit, [elemento]:valor});
    }
            ...
            <Row className="mb-4">
                <Form.Group as={Col} md="4">
                    ...
                    <Form.Control
                        ...
                        id="codigo"
                        name="codigo"
                        value={props.produtoEdit.codigo}
            ...
            <Row className="mb-4">
                <Form.Group as={Col} md="12">
                    ...
                    <Form.Control
                        ...
                        id="descricao"
                        name="descricao"
                        value={props.produtoEdit.descricao}
                        onChange={manipularMudanca}
                    />
                ...
                <Form.Group as={Col} md="4">
                    ...
                    <InputGroup hasValidation>
                        ...
                        <Form.Control
                            ...
                            value={props.produtoEdit.precoCusto}
                            onChange={manipularMudanca}
                            required
                        />
                ...
                <Form.Group as={Col} md="4">
                    ...
                    <InputGroup hasValidation>
                        ...
                        <Form.Control
                            ...
                            value={props.produtoEdit.precoVenda}
                            onChange={manipularMudanca}
                            required
                        />
                        <Form.Control.Feedback type="invalid">
                ...
                <Form.Group as={Col} md="4">
                    ...
                    <InputGroup hasValidation>
                        ...
                        <Form.Control
                            ...
                            value={props.produtoEdit.qtdEstoque}
                            onChange={manipularMudanca}
                            required
                        />
                        <Form.Control.Feedback type="invalid">
            ...
            <Row className="mb-4">
                <Form.Group as={Col} md="12">
                    ...
                    <Form.Control
                        ...
                        id="urlImagem"
                        name="urlImagem"
                        value={props.produtoEdit.urlImagem}
                        onChange={manipularMudanca}
                    />
            ...
            <Row className="mb-4">
                <Form.Group as={Col} md="12">
                    ...
                    <Form.Control
                        ...
                        id="dataValidade"
                        name="dataValidade"
                        value={props.produtoEdit.dataValidade}
                        onChange={manipularMudanca}
                    />
